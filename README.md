...
<modules>
	<module version="0.1">com.xtity.mod.TiYukkuri</module>
</modules>
...
For example,
	...
	var my_module = require('com.xtity.mod.TiYukkuri');
	my_module.foo();
...
To create a module, create a file named com.xtity.mod.TiYukkuri.js under the assets folder.
